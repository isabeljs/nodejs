...
describe("MongoCrudRepository", () => {
  ...
  const _checkInsertWhenReturningDocument = function *() {
  ...
  const _checkReplaceWhenReturningDocument = function *() {
    for (const command of arguments) {
  ...
  const _checkUpdateWhenReturningDocument = function *() {
    for (const command of arguments) {
      const article = yield _createArticle()
      const update = {
        title: "Updated article title",
  ...
  const _checkDeleteWhenReturningDocument = function *() {
    for (const command of arguments) {
      const article = yield _createArticle()
  ...
  const _checkDeleteWhenReturningDocuments = function *() {
    for (const command of arguments) {
